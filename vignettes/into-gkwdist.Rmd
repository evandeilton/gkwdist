...
family_structure <- data.frame(
  Distribution = c("Generalized Kumaraswamy (GKw)", 
                   ...
                   "Kumaraswamy (Kw)", 
                   "Beta"),
  Parameters = c("α, β, γ, δ, λ", "α, β, γ, δ", "α, β, δ, λ", 
                 "α, β, λ", "γ, δ, λ", "α, β", "γ, δ"),
  Relationship = c("Full model", "λ = 1", "γ = 1", "γ = 1, δ = 0",
...
# PDF
plot(x, density, type = "l", lwd = 2, col = "#2E4057",
     main = "Probability Density Function",
     xlab = "x", ylab = "f(x)", las = 1)
grid(col = "gray90")

# CDF
plot(x, cdf_values, type = "l", lwd = 2, col = "#8B0000",
     main = "Cumulative Distribution Function",
     xlab = "x", ylab = "F(x)", las = 1)
grid(col = "gray90")

# Histogram with theoretical density
hist(random_sample, breaks = 30, probability = TRUE, 
...
plot(theoretical_q, empirical_q, pch = 19, col = rgb(0, 0, 1, 0.3),
...
# Plot comparison
plot(x_grid, d_gkw, type = "l", lwd = 2, col = "#2E4057",
...
legend("topright",
       legend = c("GKw (5 par)", "BKw (4 par)", "EKw (3 par)", 
                  "Kw (2 par)", "Beta (2 par)"),
...
hist(data, breaks = 40, probability = TRUE,
...
plot(alpha_grid, profile_ll, type = "l", lwd = 2, col = "#2E4057",
...
plot(1:2, c(mle_profile[1], mle_profile[1]), xlim = c(0.5, 2.5), 
...
legend("topright", legend = c("MLE", "True", "Wald 95% CI", "Profile 95% CI"),
