...
**Notation:** All parameters are positive; support $x \in (0, 1)$. The
...
where $I_p^{-1}(\gamma, \delta)$ is the inverse of the regularized
...
- **Lemonte, A. J. (2013).** A new exponential-type distribution with
  constant, decreasing, increasing, upside-down bathtub and
  bathtub-shaped failure rate function. *Computational Statistics & Data
  Analysis*, 62, 149-170.
  [doi:10.1016/j.csda.2013.01.011](https://doi.org/10.1016/j.csda.2013.01.011)
