...
$\alpha = \beta = \gamma = \lambda = 1$, $\delta = 0$. It has no dedicated
functions in this package; use base R's `dunif`, `punif`, `qunif`,
`runif`, or call the GKw functions directly, e.g. `dgkw(x, 1, 1, 1, 0, 1)`.
