...
with parameters \\\gamma = 1\\, \\\delta = 0\\, and \\\lambda = 1\\. It
is also a special case of the Exponentiated Kumaraswamy
([`dekw`](https://evandeilton.github.io/gkwdist/dev/reference/dekw.md))
with \\\lambda = 1\\, and the Kumaraswamy-Kumaraswamy
([`dkkw`](https://evandeilton.github.io/gkwdist/dev/reference/dkkw.md))
with \\\delta = 0\\ and \\\lambda = 1\\.
...
(other Kw functions), [`dbeta`](https://rdrr.io/r/stats/Beta.html)
