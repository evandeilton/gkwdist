...
test_that("dmc integrates to one across the band it used to discard", {
  # The rejected band carried real probability mass: for Mc(0.3, 0.2, 0.4) the
  # density there is 7.4e-05 per unit, not zero.
  for (p in pars) {
